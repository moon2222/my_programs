...
int z;
int fillPolygon(int,int,int,int);
int main()
{
    ...
    old_color=getpixel(xin+x0,y0-yin);
    fillPolygon(xin+x0,y0-yin,fill_color,old_color);
...
int fillPolygon(int xo,int yo,int fill,int old_color)
{
    int color=getpixel(xo,yo);
    if(color==old_color)
    {
        putpixel(xo,yo,fill);
        //delay(1);
        fillPolygon(xo-1,yo,fill,old_color);
        fillPolygon(xo+1,yo,fill,old_color);
        fillPolygon(xo,yo-1,fill,old_color);
        fillPolygon(xo,yo+1,fill,old_color);
        fillPolygon(xo+1,yo+1,fill,old_color);
        fillPolygon(xo+1,yo-1,fill,old_color);
        fillPolygon(xo-1,yo+1,fill,old_color);
        fillPolygon(xo-1,yo-1,fill,old_color);
