...
int fillPolygon(int xo,int yo,int fill,int border)
{
    int color=getpixel(xo,yo);
    if(color!=border && color!=fill)
    {
        putpixel(xo,yo,fill);
       // delay(2);
        fillPolygon(xo+1,yo,fill,border);
        fillPolygon(xo-1,yo,fill,border);
        fillPolygon(xo,yo+1,fill,border);
        fillPolygon(xo,yo-1,fill,border);
        fillPolygon(xo+1,yo+1,fill,border);
        fillPolygon(xo-1,yo-1,fill,border);
        fillPolygon(xo-1,yo+1,fill,border);
        fillPolygon(xo+1,yo-1,fill,border);
