...
void boundaryfill8(int, int,int);
...
void boundaryfill8(int x , int y,int IC)
{
    if(getpixel(x,y)!=IC && getpixel(x,y)!=2)
    {
        putpixel(x,y,IC);
        boundaryfill8( x+1,  y, IC);
        boundaryfill8( x-1,  y, IC);
        boundaryfill8( x,  y+1, IC);
        boundaryfill8( x, y-1, IC);
        boundaryfill8( x+1, y+1, IC);
        boundaryfill8( x+1, y-1, IC);
        boundaryfill8( x-1, y+1, IC);
        boundaryfill8( x-1, y-1, IC);
    }
